// posts.js — fetches anime lists & handles search directly via AniList GraphQL
...
exports.getPosts = async function getPosts({ filter, page, providerValue, signal, providerContext }) {
  ...
  try {
    ...
    console.warn('[megaplay-anime posts] error:', e.message);
    return [];
  }
};
...
exports.getSearchPosts = async function getSearchPosts({ searchQuery, page, providerValue, signal, providerContext }) {
  ...
  try {
    ...
    console.warn('[megaplay-anime getSearchPosts] error:', e.message);
    return [];
  }
};
